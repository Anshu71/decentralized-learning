            ...
            {open ? (
                <div className='flex flex-col  md:hidden'>
                    <div className="px-2 pt-1 pb-3 space-y-1 sm:px-3">
                        ...
                        <a href='#courses' className="text-center cursor-pointer text-[#E0EAFF] hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Get Started
                        </a>
                    </div>
                </div>
            ) : null}
